...
const VehicleCategoryCard = ({ data, allCards }) => {
  ...
  return (
    ...
    >
    <div className="xl:max-w-[360px] mx-auto rounded-[16px] w-full flex flex-col">
      <div className=" rounded-t-[16px] relative flex">
        <img
          src={data.img}
          alt="no-image"
        ...
        <div className="flex flex-col gap-2 max-w-max absolute w-full bottom-2 right-1">
          <div className="rounded-[8px] bg-black/50 text-center backdrop-blur-sm text-white  px-2 py-1">
